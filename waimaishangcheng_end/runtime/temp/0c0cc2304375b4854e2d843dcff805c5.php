<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"E:\takeout.com\public/../application/admin\view\order\order_history_list.html";i:1554785164;}*/ ?>
...
<script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#table'
            ,height: 400
            ,url: "<?php echo url('order/historyOrderList'); ?>" //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
