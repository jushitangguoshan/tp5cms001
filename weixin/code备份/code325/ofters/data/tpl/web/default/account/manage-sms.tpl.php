				...
				<div class="modal-body">
					<div class="form-group">
						<select name="signature" class="we7-select" ng-model="middleSms.signature">
							<?php  if(!empty($notify['sms']['signature']) && in_array($notify['sms']['signature'], $signatures)) { ?>
								<option value="<?php  echo $notify['sms']['signature'];?>" ng-selected="1"><?php  echo $notify['sms']['signature'];?></option>
							<?php  } ?>
